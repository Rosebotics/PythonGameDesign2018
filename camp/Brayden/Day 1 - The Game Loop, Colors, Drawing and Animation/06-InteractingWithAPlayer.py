# TODO: Copy all of your   05-Animation.py   program and put it below this comment.# TODO: Copy all of your   04-Drawing.py   program and put it below this comment.
...
while True:
    ...
    if pressed_keys[pygame.k.get_pressed]
    xpos= xpos + 1
