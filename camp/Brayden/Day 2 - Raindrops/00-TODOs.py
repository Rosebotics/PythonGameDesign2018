...
class Raindrop:
    def __init__(self, screen, x, y, raindrop_file):
        ...
        self.x = x
        self.y = y
        self.raindrop_file = raindrop_file
        self.image_raindrop = pygame.image.load(self.raindrop_file).convert()
        self.image_raindrop = pygame.transform.scale(self.image_raindrop, (10, 10,))
        self.speed = 2
    def move(self):
...
class Hero:
    ...
    def hit_by(self, raindrop):
        ...
        # print("In hit by")
        # print(hero_box.colliderect(raindrop_box))
...
class Cloud:
    def __init__(self, screen, x, y, image, hero ):
        ...
        # TODO  Use instance variables:
        # TODO     screen  x  y  imagehit_by   raindrops.
        self.screen = screen
        self.x = x
        self.y = y
        self.image = image
    ...
    def rain(self):
        ...
        random_x = random.randint(0, 100) + self.x
       # raindrop = Raindrop(self.screen, random_x, self.y + 100)
        raindrop = Raindrop(self.screen, random_x, self.y, "11971185311926706097Gioppino_Basketball.svg.hi.png")
...
def main():
    ...
    cloud = Cloud(screen, 500, 50, "cloud.png", hero)
    # raindrop = Raindrop(screen, 500, 100, "11971185311926706097Gioppino_Basketball.svg.hi.png")
