...
# TODO           -- Control-V (to PASTE the copied code into this file.# TODO: Copy all of your   02-TheGameLoop.py   program and put it below this comment.
...
while True:
    ...
    pygame.draw. circle(screen, (200, 100, 250), (250, 130), 255)
